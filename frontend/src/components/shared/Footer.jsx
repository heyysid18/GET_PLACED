    ...
    <footer className="bg-gray-900 text-gray-300 border-t border-gray-800">
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            <h2 className="text-2xl font-bold text-white mb-4">Job<span className='text-[#6A38C2]'>Portal</span></h2>
            <p className="text-gray-400 text-sm leading-relaxed">
              Your trusted platform for finding the perfect job opportunities. Connect with top companies and advance your career.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="/jobs" className="hover:text-[#6A38C2] transition-colors">Browse Jobs</a></li>
              <li><a href="/browse" className="hover:text-[#6A38C2] transition-colors">Search Jobs</a></li>
            </ul>
          </div>
